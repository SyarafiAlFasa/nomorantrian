  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        // ambil informasi loket dari elemen span
        var loketText = $("#lokasi-loket").text().trim();

        // mainkan suara nomor antrian        
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket, " + loketText + " , Terima Kasih", "Indonesian Female", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
